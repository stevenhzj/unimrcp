...
{
	int			ret						=	MSP_SUCCESS;
	const char* login_params			=	"appid = 5d6f0aa1, work_dir = ."; // 登录参数，appid与msc库绑定,请勿随意改动
...
MRCP_PLUGIN_DECLARE(mrcp_engine_t*) mrcp_plugin_create(apr_pool_t *pool)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:mrcp_plugin_create");
...
static apt_bool_t xfyun_recog_engine_destroy(mrcp_engine_t *engine)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_engine_destroy");
...
static apt_bool_t xfyun_recog_engine_open(mrcp_engine_t *engine)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_engine_open");
	xfyun_recog_engine_t *xfyun_engine = engine->obj;
	if(xfyun_engine->task) {
		apt_task_t *task = apt_consumer_task_base_get(xfyun_engine->task);
		apt_task_start(task);
...
static apt_bool_t xfyun_recog_engine_close(mrcp_engine_t *engine)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_engine_close");
	xfyun_recog_engine_t *xfyun_engine = engine->obj;
	if(xfyun_engine->task) {
		apt_task_t *task = apt_consumer_task_base_get(xfyun_engine->task);
...
static mrcp_engine_channel_t* xfyun_recog_engine_channel_create(mrcp_engine_t *engine, apr_pool_t *pool)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_engine_channel_create");
...
static apt_bool_t xfyun_recog_channel_destroy(mrcp_engine_channel_t *channel)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_channel_destroy");
	/* nothing to destrtoy */
	return TRUE;
}
...
static apt_bool_t xfyun_recog_channel_open(mrcp_engine_channel_t *channel)
{	
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_channel_open");
...
static apt_bool_t xfyun_recog_channel_close(mrcp_engine_channel_t *channel)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_channel_close");
...
static apt_bool_t xfyun_recog_channel_request_process(mrcp_engine_channel_t *channel, mrcp_message_t *request)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_channel_request_process");
...
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_channel_recognize");
	/* process RECOGNIZE request */
...
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_channel_stop");
	/* process STOP request */
	xfyun_recog_channel_t *recog_channel = channel->method_obj;
...
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_channel_timers_start");
	xfyun_recog_channel_t *recog_channel = channel->method_obj;
	recog_channel->timers_started = TRUE;
...
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_channel_request_dispatch");
...
static apt_bool_t xfyun_recog_stream_destroy(mpf_audio_stream_t *stream)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_stream_destroy");
	return TRUE;
}
...
static apt_bool_t xfyun_recog_stream_open(mpf_audio_stream_t *stream, mpf_codec_t *codec)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_stream_open");
...
static apt_bool_t xfyun_recog_stream_close(mpf_audio_stream_t *stream)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_stream_close");
	xfyun_recog_channel_t *recog_channel = stream->obj;
	return TRUE;
}
...
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_start_of_input");
...
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_result_load");
...
void xfyun_recog_end_session(xfyun_recog_channel_t *recog_channel){
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_end_session");
...
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_recognition_complete");
...
static apt_bool_t xfyun_recog_stream_recog(xfyun_recog_channel_t *recog_channel,
	...
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_stream_recog");
...
static apt_bool_t xfyun_recog_stream_write(mpf_audio_stream_t *stream, const mpf_frame_t *frame)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_stream_write");
	xfyun_recog_channel_t *recog_channel = stream->obj;
...
static apt_bool_t xfyun_recog_msg_signal(xfyun_recog_msg_type_e type, mrcp_engine_channel_t *channel, mrcp_message_t *request)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_msg_signal");
...
static apt_bool_t xfyun_recog_msg_process(apt_task_t *task, apt_task_msg_t *msg)
{
	apt_log(RECOG_LOG_MARK,APT_PRIO_WARNING,"方法:xfyun_recog_msg_process");
